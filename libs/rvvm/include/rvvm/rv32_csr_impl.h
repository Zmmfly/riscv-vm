...
{
    public:
        virtual bool had_addr(rv32_core *core, uint16_t addr)          = 0;
        virtual bool rd(rv32_core *core, uint16_t addr, uint32_t &out) = 0;
        virtual bool wr(rv32_core *core, uint16_t addr, uint32_t in)   = 0;
};
